...
func TestShortestPathToIntersection(t *testing.T) {
	type testStruct struct {
		input    string
		expected int
	}
	...
	for i, test := range tests {
		output := shortestPathToIntersection(test.input)
		if output != test.expected {
			t.Errorf("Test '%v': ShortestPathToIntersection(%v) expected '%v' got '%v'", i, test.input, test.expected, output)
		}
	}
}
...
func TestLineSegementLength(t *testing.T) {
	type testStruct struct {
		input    lineSegment
		expected int
	}
	...
	for i, test := range tests {
		output := lineSegementLength(test.input)
		if output != test.expected {
			t.Errorf("Test '%v': ClosestIntersection(%v) expected '%v' got '%v'", i, test.input, test.expected, output)
		}
	}
...
func TestRun1(t *testing.T) {
	...
	output := closestIntersection(testInput)
	fmt.Println(output)
}
...
func TestRun2(t *testing.T) {
	...
	output := shortestPathToIntersection(testInput)
	fmt.Println(output)
}
